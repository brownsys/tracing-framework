...
public class PubSub {
     ...
     * @return a pub sub client that has kicked off a separate thread to connect
     *         to the server
     * @throws IOException
     */
    ...
    /**
     * Create a pub sub server, bind it to the default hostname
     * (pubsub.server.bindto) and port (pubsub.server.port), and start the
     * server thread
     * 
     * @return the started server
     * @throws IOException
     *             if the server could not bind to the provided host/port, or
    ...
    /**
     * Create a pub sub server, bind it to the specified hostname / port, and
     * start the server thread
     * 
     * @param bindToHostName
    ...
    /**
     * Subscribes to the specified topic, registering the provided callback,
     * using the default subscriber.
     * 
     * @param topic
     ...
     * @param subscriber
     *            the subscriber to unsubscribe, if subscribed
     */
